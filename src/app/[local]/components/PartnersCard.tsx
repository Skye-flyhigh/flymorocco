import { PartnerMeta, partnerMeta } from "@/lib/validation/partnerMeta";
...
export default function PartnersCard() {
  ...
  return (
    <article
      id="partner-cardholder"
      className="flex flex-row flex-wrap justify-center gap-5 transition-all duration-500"
    >
