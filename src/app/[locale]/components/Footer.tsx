...
export default function Footer() {
  ...
  return (
    <footer className="footer relative sm:footer-horizontal bg-base-200 text-base-content p-10">
      <div
        className="absolute w-full h-full z-0 bg-base-100"
        style={{
      ...
      <nav className="z-10">
        ...
        <div className="social-container flex flex-row gap-4 items-center">
      ...
      <nav className="z-10">
        <h5 className="footer-title">{t("legal")}</h5>
